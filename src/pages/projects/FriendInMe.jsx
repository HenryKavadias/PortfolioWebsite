        ...
        <PageLoader>
            <div className="project-page">
                ...
                <div className="ImageBlock-A">
                    <WebPageImage src="/images/FriendInMe/FriendInMeScreenshot1.png" alt="FriendInMe Screenshot 1" size={460} />
                    <WebPageImage src="/images/FriendInMe/FriendInMeScreenshot2.png" alt="FriendInMe Screenshot 2" size={460} />
                    <WebPageImage src="/images/FriendInMe/FriendInMeScreenshot3.png" alt="FriendInMe Screenshot 3" size={460} />
                </div>
            </div>
        </PageLoader>
    );
